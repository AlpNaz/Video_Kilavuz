...
public class AcilisSayfasi extends Activity implements OnClickListener
{
    private static final String LOGTAG = "AcilisSayfasi";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.acilissayfasi);
