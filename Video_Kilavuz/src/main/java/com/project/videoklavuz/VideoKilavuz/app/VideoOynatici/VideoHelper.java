...
public class VideoHelper implements OnPreparedListener,
    OnBufferingUpdateListener, OnCompletionListener, OnErrorListener
{
    ...
    // Initializes the VideoHelper object.
    public boolean init()
    {
    ...
    // Deinitializes the VideoHelper object.
    ...
    // Tells the VideoHelper to update the data from the video feed
    @SuppressLint("NewApi")
